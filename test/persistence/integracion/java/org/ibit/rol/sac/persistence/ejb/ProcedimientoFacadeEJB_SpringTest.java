...
//		EasyMock.replay(accesoManager);
	...
	public void _OKtest01BorrarTramite() {
		//procBean.eliminarTramite(625090L, 247L);
		//procBean.eliminarTramite(625218L, 247L);
		procBean.eliminarTramite(625215L, 247L);
	}
	
	
	public void _OKtest04comprobarTodosLosProcedimientosTraducidosCatalan() {
	...
	public void test01ObtenerProcedimientoConTramites()  {
		long procId = 247L;
		ProcedimientoLocal procedimiento = procBean.obtenerProcedimiento(procId);
	}
